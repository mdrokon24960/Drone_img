...
import { DetectionResponse, HistoryResponse, ImageRecord } from '@/types/detection';
...
export const getHistoryDetail = async (detectionId: string): Promise<DetectionResponse> => {
